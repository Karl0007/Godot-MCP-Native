...
func test_all_155_tools_registered():
	...
	assert_eq(all_tools.size(), 216, "Should have exactly 216 tools registered (155 + 22 World + 39 Media)")
...
func test_supplementary_tools_count():
	...
	assert_eq(supp_tools.size(), 186, "Should have 186 supplementary tools (125 + 22 World + 39 Media)")
