...
func test_all_155_tools_registered():
	...
	assert_eq(all_tools.size(), 161, "Should have exactly 161 tools registered (155 + 6 World)")
...
func test_supplementary_tools_count():
	...
	assert_eq(supp_tools.size(), 131, "Should have 131 supplementary tools (125 + 6 World)")
