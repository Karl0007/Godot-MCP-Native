...
func test_all_155_tools_registered():
	...
	assert_eq(all_tools.size(), 225, "Should have exactly 225 tools registered (155 + 22 World + 39 Media + 9 Editor)")
...
func test_supplementary_tools_count():
	...
	assert_eq(supp_tools.size(), 195, "Should have 195 supplementary tools (125 + 22 World + 39 Media + 9 Editor)")
