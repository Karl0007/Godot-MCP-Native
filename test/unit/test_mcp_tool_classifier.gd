...
func test_all_155_tools_registered():
	...
	assert_eq(all_tools.size(), 210, "Should have exactly 210 tools registered (155 + 22 World + 33 Media)")
...
func test_supplementary_tools_count():
	...
	assert_eq(supp_tools.size(), 180, "Should have 180 supplementary tools (125 + 22 World + 33 Media)")
