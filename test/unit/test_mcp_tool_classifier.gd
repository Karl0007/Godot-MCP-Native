...
func test_all_155_tools_registered():
	...
	assert_eq(all_tools.size(), 250, "Should have exactly 250 tools registered (155 + 22 World + 39 Media + 14 Editor + 6 Scene + 14 Project)")
...
func test_supplementary_tools_count():
	...
	assert_eq(supp_tools.size(), 220, "Should have 220 supplementary tools (125 + 22 World + 39 Media + 14 Editor + 6 Scene + 14 Project)")
