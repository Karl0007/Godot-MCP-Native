...
func test_all_155_tools_registered():
	...
	assert_eq(all_tools.size(), 177, "Should have exactly 177 tools registered (155 + 22 World)")
...
func test_supplementary_tools_count():
	...
	assert_eq(supp_tools.size(), 147, "Should have 147 supplementary tools (125 + 22 World)")
