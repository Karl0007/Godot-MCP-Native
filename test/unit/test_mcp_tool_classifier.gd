...
func test_all_155_tools_registered():
	...
	assert_eq(all_tools.size(), 231, "Should have exactly 231 tools registered (155 + 22 World + 39 Media + 9 Editor + 6 Scene)")
...
func test_supplementary_tools_count():
	...
	assert_eq(supp_tools.size(), 201, "Should have 201 supplementary tools (125 + 22 World + 39 Media + 9 Editor + 6 Scene)")
