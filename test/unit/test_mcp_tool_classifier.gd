...
func test_all_155_tools_registered():
	...
	assert_eq(all_tools.size(), 245, "Should have exactly 245 tools registered (155 + 22 World + 39 Media + 9 Editor + 6 Scene + 14 Project)")
...
func test_supplementary_tools_count():
	...
	assert_eq(supp_tools.size(), 215, "Should have 215 supplementary tools (125 + 22 World + 39 Media + 9 Editor + 6 Scene + 14 Project)")
