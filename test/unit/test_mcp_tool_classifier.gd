...
func test_all_155_tools_registered():
	...
	assert_eq(all_tools.size(), 183, "Should have exactly 183 tools registered (155 + 22 World + 6 Media)")
...
func test_supplementary_tools_count():
	...
	assert_eq(supp_tools.size(), 153, "Should have 153 supplementary tools (125 + 22 World + 6 Media)")
