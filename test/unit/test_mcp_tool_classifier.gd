...
func test_all_155_tools_registered():
	...
	assert_eq(all_tools.size(), 243, "Should have exactly 243 tools registered (155 + 22 World + 39 Media + 9 Editor + 6 Scene + 12 Project)")
...
func test_supplementary_tools_count():
	...
	assert_eq(supp_tools.size(), 213, "Should have 213 supplementary tools (125 + 22 World + 39 Media + 9 Editor + 6 Scene + 12 Project)")
